...
### 2.4.0 (2022-03-14)
  ...
  * Added [`Monolog\LogRecord`](vendor/monolog/monolog/src/Monolog/LogRecord.php) interface that can be used to type-hint records like `array|\Monolog\LogRecord $record` to be forward compatible with the upcoming Monolog 3 changes
...
### 2.0.0 (2019-08-30)
  ...
  * BC Break: This is a major release, see [UPGRADE.md](vendor/monolog/monolog/UPGRADE.md) for details if you are coming from a 1.x release
...
### 2.0.0-beta2 (2019-07-06)
  ...
  * BC Break: Removed SlackbotHandler, RavenHandler and HipChatHandler, see [UPGRADE.md](vendor/monolog/monolog/UPGRADE.md) for details
...
### 2.0.0-beta1 (2018-12-08)
  ...
  * BC Break: Various handler-specific breaks, see [UPGRADE.md](vendor/monolog/monolog/UPGRADE.md) for details
